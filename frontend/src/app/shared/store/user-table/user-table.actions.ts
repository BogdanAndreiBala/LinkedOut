...
export const loadUsersFailure = createAction('[User Table] Load Users Failure', props<{ error: string }>());

//User Interactions
export const setSearch = createAction('[User Table] Set Search', props<{ searchFilter: string }>());

export const setSort = createAction('[User Table] Set Sort', props<{ field: string; direction: 'asc' | 'desc' }>());
...
export const loadPreferencesFromStorage = createAction('[User Table] Load Preferences From Storage');
